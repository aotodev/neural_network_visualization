...
#if defined(APP_X11)
#define VK_USE_PLATFORM_XLIB_KHR /* includes <X11/Xlib.h> & "vulkan_xlib.h" */
#elif defined(APP_WAYLAND)
#define VK_USE_PLATFORM_WAYLAND_KHR /* includes <wayland-client.h> & "vulkan_wayland.h" */
#endif
...
namespace gs {
	...
	{
	public:
		linux_window(const window_properties& props)
			: 	m_name(props.name),
